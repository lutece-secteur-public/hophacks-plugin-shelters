...
INSERT INTO core_admin_right (id_right,name,level_right,admin_url,description,is_updatable,plugin_name,id_feature_group,icon_url,documentation_url, id_order ) VALUES 
('SHELTERS_BED_MANAGEMENT','shelters.adminFeature.ManageBeds.name',1,'jsp/admin/plugins/shelters/ManageBeds.jsp','shelters.adminFeature.ManageBeds.description',0,'shelters',NULL,NULL,NULL,4);
...
DELETE FROM core_user_right WHERE id_right = 'SHELTERS_BED_MANAGEMENT';
